-- Zameel manual deployment helper
-- Run this file once in Supabase SQL Editor if migration 011 has not been applied.
-- It is intentionally idempotent (CREATE IF NOT EXISTS / DROP POLICY IF EXISTS).
