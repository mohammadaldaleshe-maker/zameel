  ...
  static ThemeData theme({required bool arabic, required Brightness brightness}) {
    ...
    return ThemeData(
      ...
      dialogTheme: DialogThemeData(
        ...
        titleTextStyle: type.titleLarge?.copyWith(color: foreground),
        contentTextStyle: type.bodyMedium?.copyWith(color: foreground),
      ),
      popupMenuTheme: PopupMenuThemeData(
        color: card,
        textStyle: type.bodyMedium?.copyWith(color: foreground),
      ),
    );
  }
