...
class _JobsScreenState extends State<JobsScreen> {
  ...
  final List<Map<String, dynamic>> jobs = [
    {
      ...
      'description_en':
          'We are looking for a Flutter Developer to join our development team',
      'requirements_ar': 'خبرة في Flutter و Dart، مهارات التواصل الجيد',
      'requirements_en':
          'Experience in Flutter and Dart, good communication skills',
      'salary': '500 - 700 JOD',
      'deadline': '2024-07-15',
      'isRemote': false,
      'isUrgent': true,
    ...
    },
    {
      ...
      'description_en':
          'Internship opportunity for Software Engineering students',
      'requirements_ar':
          'طالب في السنة الثالثة أو الرابعة، معرفة بأساسيات البرمجة',
      'requirements_en':
          '3rd or 4th year student, knowledge of programming basics',
      'salary': 'غير مدفوع',
      'deadline': '2024-06-30',
      'isRemote': false,
      'isUrgent': false,
    ...
    },
    {
      ...
      'description_en':
          'Internship opportunity in digital marketing with a professional team',
    ...
    },
    {
      ...
      'description_en':
          'Summer training in web development using React and Node.js',
  ...
  List<Map<String, dynamic>> get filteredJobs {
    // Never mix expired demo records with the live feed.
