  ...
  void _sendMessage() {
    ...
    Future.delayed(const Duration(seconds: 2), () {
      setState(() {
        _messages.add({
          'isUser': false,
          'text_ar': _getAIResponse(text, true),
          'text_en': _getAIResponse(text, false),
          'time': DateTime.now().toIso8601String().substring(11, 16),
        });
        _isLoading = false;
      });
        ...
        Container(
          ...
          child: Row(
            children: [
              ...
              const SizedBox(width: 8),
              CircleAvatar(
                backgroundColor: _isLoading ? AppTheme.muted : AppTheme.primary,
                child: _isLoading
                    ? const SizedBox(
                        width: 20,
                        height: 20,
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              onPressed: () {
                ...
                setState(() {
                  _summary = isArabic
                      ? '📌 ملخص النص:\n\n${_textController.text.substring(0, _textController.text.length > 100 ? 100 : _textController.text.length)}...\n\nهذا هو ملخص مختصر للنص. يمكنك استخدام هذه الأداة لتلخيص المقالات والمواد الدراسية بسرعة.'
                      : '📌 Summary:\n\n${_textController.text.substring(0, _textController.text.length > 100 ? 100 : _textController.text.length)}...\n\nThis is a brief summary of the text. You can use this tool to quickly summarize articles and study materials.';
                });
              },
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              onPressed: () {
                ...
                setState(() {
                  _explanation = isArabic
                      ? '📖 شرح المفهوم: ${_textController.text}\n\nهذا مفهوم مهم في مجال الدراسة. يمكنك استخدام هذا الشرح لفهم الفكرة بشكل أفضل. هل تريد شرحاً أكثر تفصيلاً؟'
                      : '📖 Explanation: ${_textController.text}\n\nThis is an important concept in the field of study. You can use this explanation to understand the idea better. Do you want a more detailed explanation?';
                });
              },
              style: ElevatedButton.styleFrom(
                backgroundColor: AppTheme.primary,
      ...
      child: Row(
        ...
        children: [
          Container(
            ...
            padding: const EdgeInsets.all(12),
            decoration: BoxDecoration(
              color: isUser ? AppTheme.primary : AppTheme.muted.shade200,
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  time,
                  style: TextStyle(
                    color: isUser ? Colors.white70 : AppTheme.muted.shade600,
                    fontSize: 10,
                  ),
                ),
              ],
...
class _SampleQuestionChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ActionChip(
      ...
      onPressed: onTap,
      backgroundColor: AppTheme.muted.shade100,
      shape: RoundedRectangleBorder(
