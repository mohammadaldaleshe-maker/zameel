...
class _BusinessScreenState extends State<BusinessScreen> {
  ...
  Widget _hero(bool ar) => Container(
    ...
    decoration: BoxDecoration(gradient: const LinearGradient(colors: [Color(0xFF0B9F95), Color(0xFF0B9F95)]), borderRadius: BorderRadius.circular(24)),
  ...
  Widget _partnerCard(Map<String, dynamic> p, bool ar) => Card(margin: const EdgeInsets.only(bottom: 10), child: InkWell(onTap: () => _showPartner(p, ar), borderRadius: BorderRadius.circular(18), child: Padding(padding: const EdgeInsets.all(14), child: Row(children: [Container(width: 54, height: 54, decoration: BoxDecoration(color: const Color(0xFFE1FBF8), borderRadius: BorderRadius.circular(16)), child: Icon(p['icon'], color: const Color(0xFF0B9F95), size: 28)), const SizedBox(width: 12), Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [Row(children: [Expanded(child: Text(p['name'], style: const TextStyle(fontWeight: FontWeight.w800, fontSize: 16))), Container(padding: const EdgeInsets.symmetric(horizontal: 7, vertical: 3), decoration: BoxDecoration(color: const Color(0xFFE1FBF8), borderRadius: BorderRadius.circular(8)), child: Text(p['tag'], style: const TextStyle(fontSize: 10, fontWeight: FontWeight.bold, color: Color(0xFF0B9F95))))]), const SizedBox(height: 4), Text(p['desc'], maxLines: 2, overflow: TextOverflow.ellipsis, style: const TextStyle(color: Colors.grey, height: 1.35))])), const Icon(Icons.chevron_left_rounded, color: Colors.grey)]))));
