        ...
        children: [
          Container(
            decoration: BoxDecoration(
              ...
              boxShadow: const [
                BoxShadow(blurRadius: 18, offset: Offset(0, 8), color: AppTheme.overlayMedium),
              ],
            ),
            child: Padding(
                          ...
                          child: Column(
                            children: [
                              Icon(_checkedIn ? Icons.check_rounded : Icons.local_fire_department_rounded,
                                  color: _checkedIn ? Colors.white : AppTheme.accent, size: 20),
                              Text(
                                '$_streak',
                                style: TextStyle(
                                  color: _checkedIn ? Colors.white : AppTheme.primaryDark,
