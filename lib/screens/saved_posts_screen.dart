        ...
        body: savedPosts.isEmpty
            ? Center(
                child: Column(
                  ...
                  children: [
                    Icon(Icons.bookmark_border_rounded, size: 64, color: AppTheme.muted.shade400),
                    const SizedBox(height: 12),
                    Text(
                      isArabic ? '📭 لا توجد منشورات محفوظة' : '📭 No saved posts',
                      style: TextStyle(fontSize: 18, color: AppTheme.muted.shade600, fontWeight: FontWeight.bold),
                    ),
                  ],
                ),
              )
                          ...
                          Row(
                            children: [
                              const CircleAvatar(
                                ...
                                child: Icon(Icons.person_rounded, color: AppTheme.primaryDark, size: 20),
                              ),
