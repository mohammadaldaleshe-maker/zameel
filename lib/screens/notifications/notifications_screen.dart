        ...
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (_) => BooksScreen(
              ...
              initialIncomingRequests: type == 'book_exchange_request',
            ),
          ),
        );
      }
    ...
    if (postId.isNotEmpty) {
      try {
        ...
        if (post != null && mounted) {
          Navigator.push(context, MaterialPageRoute(builder: (_) => CommentsScreen(post: Map<String, dynamic>.from(post), highlightedCommentId: data['comment_id']?.toString())));
          return;
        }
      } catch (_) {}
    }
