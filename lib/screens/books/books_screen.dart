                  ...
                  child: Column(
                    ...
                    children: [
                      Container(
                        ...
                        child: Row(
                          children: [
                            Icon(_fileIcon(picked.extension), color: const Color(0xFF0B9F95), size: 32),
                    ...
                    return Padding(
                      ...
                      child: FilterChip(
                        ...
                        labelStyle: TextStyle(
                          color: isSelected ? const Color(0xFF0B9F95) : Colors.black,
              ...
              Padding(
                ...
                child: Card(
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      children: [
                        const Icon(Icons.school_rounded, color: Color(0xFF0B9F95), size: 32),
                        const SizedBox(width: 10),
                        Expanded(
                          child: Text(
                              ...
                              return Card(
                                ...
                                child: ListTile(
                                  leading: CircleAvatar(
                                    ...
                                    child: Icon(_fileIcon(extension), color: const Color(0xFF0B9F95)),
                                  ),
...
class _BookCard extends StatelessWidget {
  ...
  Color _getTypeColor(String type) {
    switch (type) {
      ...
      case 'مبادلة':
      case 'Exchange':
        return Color(0xFF18D3C3);
      case 'إعارة':
      case 'Lend':
        return Colors.orange;
      case 'تبرع':
      case 'Donate':
        return Color(0xFF0B9F95);
      default:
        return Colors.grey;
    }
  }
