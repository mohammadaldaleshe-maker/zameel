...
class ZameelBubbleActivity : Activity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // A message-created overlay service is short-lived. Opening the
        // conversation closes its chat head and removes that message service
        // notification; the next message can start a fresh overlay.
        ZameelOverlayService.hideBubbleAndStop(this, keepMessageNotification = false)
